...
/datum/subsystem/ticker/New()
	...
	login_music = pickweight(list('sound/ambience/title2.ogg' = 23, 'sound/ambience/title1.ogg' =23, 'sound/ambience/title3.ogg' =23, 'sound/ambience/title4.ogg' =23)) // choose title music!
...
/datum/subsystem/ticker/fire()
	switch(current_state)
		if(GAME_STATE_STARTUP)
			...
			world << "<span class='boldnotice'>Welcome to Interstation: [station_name()]!</span>"
...
/datum/subsystem/ticker/proc/setup()
	...
	world << "<FONT color='blue'><B>Welcome to Interstation: [station_name()], enjoy your stay!</B></FONT>"
...
/datum/subsystem/ticker/proc/choose_aspect()//There has got to be a better way to do this than hardcoding.
	var/aspect1 = pick(/datum/round_event/aspect/bad_hop/clown, /datum/round_event/aspect/gifted, /datum/round_event/aspect/clownstation, /datum/round_event/aspect/erp, /datum/round_event/aspect/two_caps, /datum/round_event/aspect/eimplant)
	var/aspect2 = pick(/datum/round_event/aspect/bad_hop, /datum/round_event/aspect/toolbox_salesman, /datum/round_event/aspect/identity_crisis, /datum/round_event/aspect/neko, /datum/round_event/aspect/kungfu, /datum/round_event/aspect/quiet)
			...
			if(Player.stat != DEAD && !isbrain(Player))
				...
				if(station_evacuated) //If the shuttle has already left the station
					if(!Player.onCentcom() && !Player.onSyndieBase())
						Player << "<font color='blue'><b>You managed to survive, but were marooned on Interstation: [station_name()]...</b></FONT>"
					else
						num_escapees++
						Player << "<font color='green'><b>You managed to survive the events on Interstation: [station_name()] as [Player.real_name].</b></FONT>"
				else
					Player << "<font color='green'><b>You managed to survive the events on Interstation: [station_name()] as [Player.real_name].</b></FONT>"
			else
				Player << "<font color='red'><b>You did not survive the events on Interstation: [station_name()]...</b></FONT>"
