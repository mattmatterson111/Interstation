...
var/global/list/station_names = list("Fuck This Shit", "No Memes Allowed", "Murder Boner Simulator", "READ THE FUCKING RULES",
	"Rick Sanchez", "You're Here Forever","A Normal Round", "The Wild Ride", "Spessmen Simulator", "You Won't Survive", "IT'S ALL OVER NOW",
	"Fresh Memes", "Dank Memes")/*"", "Stanford", "Dorf", "Alium",
