...
/world/Reboot(var/reason, var/feedback_c, var/feedback_r, var/time)
	...
	spawn(soundwait/2)
		if(ticker && ticker.round_end_sound)
			...
			world << sound(pick('sound/misc/endsound1.ogg', 'sound/misc/endsound2.ogg', 'sound/misc/endsound3.ogg', 'sound/misc/endsound4.ogg'))//,'sound/misc/apcdestroyed.ogg','sound/misc/bangindonk.ogg','sound/misc/leavingtg.ogg', )) // random end sounds!! - LastyBatsy
	sleep(soundwait)
	for(var/thing in clients)
		var/client/C = thing
		if (!C)
