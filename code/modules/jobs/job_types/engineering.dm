...
/datum/outfit/job/engineer
	...
	wage = 450
	pda_slot = slot_l_store
	backpack_contents = list(/obj/item/device/modular_computer/tablet/preset/advanced=1, /obj/item/device/t_scanner=1)
...
/datum/outfit/job/atmos
	...
	wage = 450
	pda_slot = slot_l_store
	backpack_contents = list(/obj/item/device/modular_computer/tablet/preset/advanced=1, /obj/item/device/analyzer=1)
