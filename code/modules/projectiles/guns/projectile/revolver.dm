...
/obj/item/weapon/gun/projectile/revolver/attack_self(mob/living/user)
	...
	if (num_unloaded)
		...
		playsound(user, pick('sound/effects/wep_misc/casing_bounce1.ogg', 'sound/effects/wep_misc/casing_bounce2.ogg', 'sound/effects/wep_misc/casing_bounce3.ogg'), 15, 1, -1)
...
/obj/item/weapon/gun/projectile/revolver/detective/New()
	...
	options["Snub Nosed"] = "detective_snub"
	options["Cancel"] = null
...
/obj/item/weapon/gun/projectile/revolver/doublebarrel/attack_self(mob/living/user)
	...
	if (num_unloaded)
		...
		playsound(user, 'sound/effects/wep_misc/shotgun_shell_bounce.ogg', 50, 1)
	else
		user << "<span class='warning'>[src] is empty!</span>"
